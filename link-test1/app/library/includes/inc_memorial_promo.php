...
#promo-modal .modal-content{
  ...
  background-image:url(../../images/memorial-bg.png);
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img class="img-responsive center-block"  src="../../images/memorial-words.png"></img>
      </div>
      <div class="modal-footer">
          <button type="button" data-dismiss="modal" class="btn btn-special not-now">later</button>
          <a href="http://shop.daskeyboard.com/collections/products/sale" type="button" class="btn btn-special btn-color" >SHOP NOW!</a>
       </div>

...
var g_navPanDolly = -15;        // Distance when pan changes to rotation
var g_navMode2DecayDown = 0.1;  // Mouse down decay
var g_navMode2DecayUp = 0.9;    // General decay
var g_navMode2Speed = 0.03;     // Navigation speed

var panMax = [8, 3];    //[left, bottom];
var panMin = [-5, -3];  //[right, top];
...
function NavPan(mdelta) {
    ...
    if (g_navMode == 2) {
        ...
        g_navPan[0] += mdelta[0] / 75.0;
        g_navPan[1] -= mdelta[1] / 75.0;

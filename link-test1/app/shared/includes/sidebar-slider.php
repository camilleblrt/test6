<style>
  ...
  #headerSidebar {
    ...
    padding: 20px 40px;
    border-radius: 3px;
    background: url("/shared/images/background-sidebar.png");
    background-size: 100%;
...
<div id="sliderSidebar" style="bottom: -42%;">
  <div id="sidebar" onclick="open_panel()"><img src="/shared/images/top-sidebar.png" style="width: 100%;"></div>
...
<script src="/shared/js/sidebar-slider.js"></script>

...
if ($show_navigation_buttons == "true") {
	$back_src = "<img width='1050px' height='523px' src='$back_button' alt='back' class='nav_buttons' class='nav_buttons'>";
	$next_src = "<img width='1050px' height='523px' src='$next_button' alt='next' class='nav_buttons' class='nav_buttons'>";
}
else {
	$back_src = "$lang_back";
	$next_src = "$lang_next";
...
if (($currentPic - $half) < 0) { // near the start...
    ...
    for ( $x=($number_pics-abs($underage+1)); $x<$number_pics; $x++) {
        ...
        $out .= "\n<a href='$path?directory=$path_to_images$auto_url&currentPic=$next' class='thumbnail'><img width='1050px' height='523px' src='$path_to_images/$thumbnail_dir/".$item[0]."' class='thumbnail'></a>";
    }
...
$out .= "\n<img width='1050px' height:'523px' src='$path_to_images/$thumbnail_dir/".rtrim($item[0])."' class='thumbnail_center'>";
...
function my_filmstrip($thumbnail_dir, &$template, $a_images, $currentPic, $thumb_row, $path_to_images) {
    ...
    for ($x = $start; $x < ($start + $thumb_row); $x++ ) {
        ...
        $out .= "\n<a href='$path?directory=$path_to_images$auto_url&currentPic=$x' class='thumbnail'><img width='1050px' height='523px' src='$path_to_images/$thumbnail_dir/".$item[0]."' class='$class'></a>";
    }
...
$images .= "<img width='1050px' height='523px' src='$path_to_images/$item[0]' class='image' alt='$lang_img_alt' title='$lang_img_hover'></a>";
